# Write a Python function combinationSort(strList) that takes a list of unique strings strList as an argument, where each string is a combination of a letter from a to z and a number from 0 to 99, the initial character in string being the letter.
...
def combinationSort(strList):
  # dictionary with 26 keys from characters 'a' to 'z', each key has an empty list as value.
